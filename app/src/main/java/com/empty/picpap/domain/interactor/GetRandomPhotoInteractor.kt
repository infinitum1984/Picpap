...
class GetRandomPhotoInteractor @Inject constructor(private val randomPhotoRepository: RandomPhotoRepository,
    ...
    override suspend fun invoke(): DomainResult<RandomPhotoDomain> {
        val randomPhoto = randomPhotoRepository.getRandomPhoto()
